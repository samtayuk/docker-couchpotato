...
RUN wget -P /tmp/ https://github.com/RuudBurger/CouchPotatoServer/archive/build/$COUCHPOTATO_VERSION.tar.gz
RUN tar -C /opt/couchpotato -xvf /tmp/$COUCHPOTATO_VERSION.tar.gz --strip-components 1
